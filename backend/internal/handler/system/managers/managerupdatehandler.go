...
func ManagerUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ManagerUpdateReq
		if err := httpx.Parse(r, &req); err != nil {
			response.APIResponse(w, 0, nil, err)
			return
		}

		l := managers.NewManagerUpdateLogic(r.Context(), svcCtx)
		resp, err := l.ManagerUpdate(&req)
		if err != nil {
